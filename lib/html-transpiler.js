...
(function (root, factory) {
  ...
  // Matches: <tagname ...attrs.../>  or  <tagname ...attrs...>  or  </tagname>
  ...
  function transpileHTML(source) {
    const warnings = [];
    const result = source.replace(TAG_RE, (full, rawTag, attrString, selfClose, offset) => {
