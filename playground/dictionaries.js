(function (root, factory) {
  ...
  const CSS_PROPS = {
    ...
    // ---- added: more layout/box/visual properties commonly needed ----
    "ዙሪያ-መስመር": "outline", "zuriya-mesmer": "outline",
    "ሳጥን-አሰራር": "box-sizing", "saten-aserar": "box-sizing",
    "ታይነት": "visibility", "taynet": "visibility",
    "ተንሳፋፊ": "float", "tensafafi": "float",
    "አጽዳ": "clear", "atsda": "clear",
    "ቀጥ-አሰላለፍ": "vertical-align", "ketet-aselalef": "vertical-align",
    "ባዶ-ቦታ": "white-space", "bado-bota": "white-space",
    "ፊደል-መደብ": "text-transform", "yefidel-medeb": "text-transform",
    "ዝርዝር-ቅርጽ": "list-style", "zirzir-kirts": "list-style",
    "ጀርባ-ምስል": "background-image", "jerba-mesele": "background-image",
    "ጀርባ-መጠን": "background-size", "jerba-meten": "background-size",
    "ጀርባ-ቦታ": "background-position", "jerba-bota": "background-position",
    "ጀርባ-ድገማ": "background-repeat", "jerba-digema": "background-repeat",
    "ፊደል-አቀማመጥ": "font-style", "yefidel-akemamet": "font-style",
    "ፅሁፍ-ጥላ": "text-shadow", "yetsihuf-tila": "text-shadow",
    "ፍሰት-መጠቅለያ": "flex-wrap", "yefiset-metekleya": "flex-wrap",
    "ፍሰት-እድገት": "flex-grow", "yefiset-idget": "flex-grow",
    "ፍሰት-ጥበት": "flex-shrink", "yefiset-tibet": "flex-shrink",
    "ራስ-አሰላለፍ": "align-self", "ras-aselalef": "align-self",
    "ይዘቶች-አሰላለፍ": "align-content", "yizetoch-aselalef": "align-content",
    "ቅደም-ተከተል": "order", "kidem-teketel": "order",
    "ፍርግርግ-አምዶች": "grid-template-columns", "firgrig-amdoch": "grid-template-columns",
    "ፍርግርግ-ረድፎች": "grid-template-rows", "firgrig-redfoch": "grid-template-rows",
    "ምስል-ልክ": "object-fit", "mesele-lik": "object-fit",
    "ማስተካከያ": "resize", "mastekakeya": "resize",
    "ማጣሪያ": "filter", "matareya": "filter",
    "እንቅስቃሴ": "animation", "enkeskase": "animation",
    "እንቅስቃሴ-ቆይታ": "animation-duration", "enkeskase-koyita": "animation-duration",
  };
  ...
  const RUNTIME_ALIASES = {
    ...
    // ---- added: common browser APIs beyond DOM manipulation ----
    "አምጣ": "amta",                   // fetch(url) -> parsed JSON, as a Promise
    "ጠብቅ": "tebk",                   // setTimeout(fn, ms) — "wait, then..."
    "ቋሚ_አስቀምጥ": "kwami_askemt",      // localStorage.setItem
    "ቋሚ_አግኝ": "kwami_agn",           // localStorage.getItem
    "ቋሚ_አጥፋ": "kwami_atfa",          // localStorage.removeItem
    "ዘፈቀደ": "zefekede",              // Math.random(), 0 to 1
    "ዘፈቀደ_ቁጥር": "zefekede_kutir",    // Math.random() scaled to a [ከ, እስከ] integer range
    "ወደ_ጽሁፍ": "wede_tsihuf",         // JSON.stringify
    "ወደ_እቃ": "wede_iqa",             // JSON.parse
  };
